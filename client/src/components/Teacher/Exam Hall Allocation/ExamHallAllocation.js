  ...
  return (
    <div>
      ...
      <div className={`sidebar ${isSidebarActive ? 'active' : ''}`} id="sidebar">
        <div className="logo">
          <img src="Examhall/logo.png" alt="Logo" />
        </div>
        ...
        <br /><br /><br />
        <span>
          <img src="./Examhall/logout.png" height="40" width="80" alt="Logout" id="l1" />
        </span>
      </div>
      ...
      <div className="container">
        <span id="fa">
          <img src="./Examhall/faculty.png" height="50" width="150" alt="Faculty" id="f00" />
        </span>
        <img src="./Examhall/arrow.png" height="40" width="40" id="a2" alt="Arrow" />
