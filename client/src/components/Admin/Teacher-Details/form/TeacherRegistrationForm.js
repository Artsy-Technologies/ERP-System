...
const TeacherRegistrationForm = () => {
  ...
  const onSubmit = async (data) => {
    ...
    for (const key in data) {
      if (key === 'photo') {
        const photoFile = data.photo[0]; // Get the photo file
        if (photoFile) {
          formData.append('photo', photoFile); // Append the file directly
        }
      } else {
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="teacher-form">
        <div className="row">
          ...
          <div className="col-md-6">
            ...
            <div className="form-group mb-3">
              <label>Gender:</label>
              <input className="form-control" {...register("gender", { required: true })} />
              {errors.gender && <span className="text-danger">This field is required</span>}
            </div>
            <div className="form-group mb-3">
              <label>Nationality:</label>
              <input className="form-control" {...register("nationality", { required: true })} />
              {errors.nationality && <span className="text-danger">This field is required</span>}
            </div>
            <div className="form-group mb-3">
              <label>Class Allotted:</label>
              <input className="form-control" {...register("classAllotted", { required: true })} />
            ...
            <div className="form-group mb-3">
              <label>Address:</label>
              <textarea className="form-control" rows="3" {...register("address", { required: true })}></textarea>
          ...
          <div className="col-md-6">
            ...
            <div className="mb-4">
              ...
              <div className="form-group mb-3">
                ...
                <input className="form-control" type="number" {...register("ugYear", { required: true })} />
                {errors.ugYear && <span className="text-danger">This field is required</span>}
              </div>
              <div className="form-group mb-3">
                <label>University Name and Address:</label>
                <textarea className="form-control" rows="2" {...register("ugUniversity", { required: true })}></textarea>
            ...
            <div className="mb-4">
              ...
              <div className="form-group mb-3">
                <label>Year of Passing:</label>
                <input className="form-control" type="number" {...register("pgYear", { required: true })} />
                {errors.pgYear && <span className="text-danger">This field is required</span>}
              </div>
              <div className="form-group mb-3">
                <label>University Name and Address:</label>
                <textarea className="form-control" rows="2" {...register("pgUniversity", { required: true })}></textarea>
